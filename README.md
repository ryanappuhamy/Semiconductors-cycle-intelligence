...
**Downturn** — Counter-intuitively, average forward returns during classified downturns in this backtest are also positive (NVDA ~+102% at 12 months, n = 10). That largely reflects buying recoveries *from* cycle troughs rather than smooth returns *through* contraction. Downturn labels mark stress in the model inputs, not necessarily the moment of maximum equity downside.
